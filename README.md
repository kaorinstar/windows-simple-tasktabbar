...
![The settings window in two columns: language, bar height, colours, tab order and window preview on the left, bar position, displays, tab groups, excluded applications and updates on the right](docs/images/settings.png)
